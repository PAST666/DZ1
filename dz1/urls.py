...
from cabinet.views import main, price, AppointmentView, license, gallery, preparation, reviews, ThanksView, Delete_View, get_services_by_master, VisitApiView, VisitApiView2, VisitApiView3
from django.conf import settings
from django.conf.urls.static import static
from rest_framework import routers

router = routers.DefaultRouter()
router.register(r'api/visit', VisitApiView)
